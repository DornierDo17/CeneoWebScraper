...
class ExtractForm(Form):
    product_id = StringField("Product id", name="product_id", id="product_id")
    submit = SubmitField("Extract opinions", validators=[validators.DataRequired(message="Produc id is required"), 
